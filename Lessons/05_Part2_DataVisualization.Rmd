...
```{r, fig.height = 3, fig.width = 4, warning = FALSE}
#geom_hline --> horizontal line. lty = 2 --> dashed line. geom_text --> specify location of text. label --> text to add. hjust --> alignment. 
...
# let's first make the plot look better. alpha --> transparency
...
#multiple plots in a grid, specify dimensions. rel_heights --> plots of different sizes
