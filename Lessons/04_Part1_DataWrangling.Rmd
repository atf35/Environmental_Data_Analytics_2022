...
# matrix filtering: filter rows that have "0" in the column "depth"
...
NTL.phys.data.TuesdayLake1990thru1999 <- filter(NTL.phys.data, lakename == "Tuesday Lake" & year4 %in% c(1990:1999))
summary(NTL.phys.data.TuesdayLake1990thru1999)
